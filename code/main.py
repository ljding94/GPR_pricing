...
def main(product="american_put", label=0, N_data=10, folder="../data/data_pool"):
    # Generate the dataset
    if product.lower() == "american_put":
        generate_american_put_data_set(folder, label=label, N_data=N_data)
...
if __name__ == "__main__":
    ...
    main(product, label, N_data, folder)
